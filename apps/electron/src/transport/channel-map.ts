...
export const CHANNEL_MAP = {
  ...
  getCaptureAutofillHotkey: invoke(RPC_CHANNELS.app.GET_CAPTURE_AUTOFILL_HOTKEY),
  setCaptureAutofillHotkey: invoke(RPC_CHANNELS.app.SET_CAPTURE_AUTOFILL_HOTKEY),
  onCaptureAutofillHotkeyChanged: listener(RPC_CHANNELS.app.CAPTURE_AUTOFILL_HOTKEY_CHANGED),
  onCaptureAutofillHotkeyConflict: listener(RPC_CHANNELS.app.CAPTURE_AUTOFILL_HOTKEY_CONFLICT),
