...
const EXPECTED_CHANNELS: string[] = [
  ...
  'LLM_Connection:test',
  'app:captureAutofillHotkey:changed',
  'app:captureAutofillHotkey:conflict',
  'app:captureAutofillHotkey:get',
  'app:captureAutofillHotkey:set',
  'app:captureHotkey:changed',
  'app:captureHotkey:conflict',
  'app:captureHotkey:get',
  'app:captureHotkey:set',
  ...
  'days:get',
  'days:getBoard',
  'days:incompleteTasks',
  'days:list',
  'days:moveTask',
  'days:pullForward',
  'days:updateFile',
  'days:updateTaskLists',
  'daysTray:getDetachedAlwaysOnTop',
  'daysTray:getEnabled',
  'daysTray:setDetachedAlwaysOnTop',
  'daysTray:setEnabled',
  'debug:log',
  'deeplink:navigate',
  'dialog:openFolder',
